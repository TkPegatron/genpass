...
fn get_horse_words(config: &PasswordConfig, corpus: &Vec<String>) -> Vec<String> {
...
pub fn fancy_correct_horse(config: &PasswordConfig, corpus: &Vec<String>) -> String {
  ...
  let words = get_horse_words(config, corpus);
...
pub fn correct_horse(config: &PasswordConfig, corpus: &Vec<String>) -> String {
